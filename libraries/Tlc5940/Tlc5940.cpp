...
static inline void enable_XLAT_pulses() { asm("nop"); };
static inline void set_XLAT_interrupt() { asm("nop"); };
static inline void disable_XLAT_pulses() { asm("nop"); };
static inline void clear_XLAT_interrupt() { asm("nop"); };
static inline void sei() { asm("nop"); };
